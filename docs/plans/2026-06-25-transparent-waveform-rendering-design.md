...
Interface Builder instances with `isOpaque = false`, and restore an assigned
background color after the existing context clear without filling when it is nil.
